...
describe("safe css policy", () => {
  it("accepts registered parts and allowed pseudo states", () => {
    const result = validateSafeCss(
      '[data-ds-part="root"] { color: #f8fafc; } [data-ds-part="sidebar"] { color: var(--ds-theme-color-sidebar-text); } [data-ds-part="header"]:hover { background-color: #334155; } [data-ds-part="composer"]:focus-within { border-color: var(--ds-theme-color-accent-alt); }',
    );
